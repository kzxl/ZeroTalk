...
namespace ZeroTalk.Server.Data
{
    ...
    public class UserStore
    {
        ...
        private void LoadUsers()
        {
            ...
            if (File.Exists(_filePath))
            {
                try
                {
                    ...
                    _users = ZeroTalk.Shared.Protocol.PacketSerializer.FromJson<List<UserAccount>>(json) ?? new List<UserAccount>();
                }
                catch
                {
                    _users = new List<UserAccount>();
        ...
        private void SaveUsers()
        {
            try
            {
                var json = ZeroTalk.Shared.Protocol.PacketSerializer.ToJson(_users);
