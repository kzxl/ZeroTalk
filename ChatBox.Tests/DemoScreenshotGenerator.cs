...
{
    /// <summary>
    /// Generates high-fidelity, pixel-perfect demo screenshots of the ChatBox application suite
    ...
    public static class DemoScreenshotGenerator
    {
        ...
        public static void GenerateServerDashboard(string filePath)
        {
            ...
            using (var g = Graphics.FromImage(bmp))
            {
                ...
                DrawWindowFrame(g, w, h, "ChatBox Server Dashboard — Telemetry & Connection Hub");
        ...
        public static void GenerateClientChat(string filePath)
        {
            ...
            using (var g = Graphics.FromImage(bmp))
            {
                ...
                DrawWindowFrame(g, w, h, "ChatBox — Alice (SecOps)");
                ...
                {
                    g.DrawString("ChatBox — Signed in as: Alice (SecOps)", topFont, Brushes.White, 38, 42);
                }
        ...
        public static void GenerateLoginScreen(string filePath)
        {
            ...
            using (var g = Graphics.FromImage(bmp))
            {
                ...
                DrawWindowFrame(g, w, h, "ChatBox — Sign In");
                ...
                g.DrawString("ChatBox Simple", new Font("Segoe UI Semibold", 14f, FontStyle.Bold), Brushes.White, cardX + 55, y);
                y += 28;
